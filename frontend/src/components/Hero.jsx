...
export default function Hero() {
  return (
    <section className="relative min-h-screen pt-24 sm:pt-32 pb-12 sm:pb-20 flex items-center justify-center overflow-hidden bg-white">
      {/* Background */}
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 text-center z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center mb-8 sm:mb-12">
          ...
          <div className="text-center lg:text-left max-w-xl mx-auto lg:mx-0">
            ...
            <div className="inline-flex items-center gap-2 rounded-full border border-pink-200 bg-pink-50 px-3.5 py-1.5 sm:px-4 sm:py-2 text-xs sm:text-sm font-medium text-pink-600 shadow-xs">
              <Sparkles className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
              India's Smart Product Customizer
            </div>

            {/* Heading */}
            <h1 className="mt-5 sm:mt-8 text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-black tracking-tight leading-[1.1] sm:leading-[0.95] text-slate-900">
              Customize
              <br />
            ...
            <p className="mt-3 sm:mt-4 text-xs sm:text-base lg:text-lg leading-relaxed text-slate-600 max-w-lg mx-auto lg:mx-0">
            ...
            <div className="mt-6 sm:mt-10 flex items-center justify-center lg:justify-start">
              <Link
                to="/contact"
                className="w-full sm:w-auto group relative inline-flex items-center justify-center overflow-hidden rounded-full bg-gradient-to-r from-pink-500 via-rose-500 to-pink-600 px-8 py-3.5 sm:py-4 font-semibold text-white shadow-lg shadow-pink-500/30 transition-all duration-500 hover:-translate-y-1 hover:scale-105 hover:shadow-2xl hover:shadow-pink-500/40 active:scale-95 text-sm sm:text-base"
              >
                {/* Animated Glow */}
                <span
            ...
            {/* Stats Row: 3 columns clean on mobile & desktop */}
            <div className="mt-8 sm:mt-12 pt-6 sm:pt-8 border-t border-slate-200/60 lg:border-none grid grid-cols-3 gap-2 sm:gap-6 max-w-md mx-auto lg:mx-0">
              <div className="text-center lg:text-left">
                <h3 className="text-2xl sm:text-3xl font-extrabold text-slate-900">200+</h3>
                <p className="text-[11px] sm:text-sm text-slate-500 mt-0.5 sm:mt-1 font-medium leading-tight">
                  Orders Delivered
                </p>
              </div>

              <div className="text-center lg:text-left border-x border-slate-200/60 lg:border-none px-1">
                <h3 className="text-2xl sm:text-3xl font-extrabold text-slate-900">48 Hrs</h3>
                <p className="text-[11px] sm:text-sm text-slate-500 mt-0.5 sm:mt-1 font-medium leading-tight">
                  Fast Production
                </p>
              </div>
        ...
        {/* Features Row */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 mt-6 sm:mt-12 text-left">
          <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xs sm:shadow-lg p-5 sm:p-8 border border-slate-100">
            <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-cyan-100 flex items-center justify-center mb-4 sm:mb-5">
              <Sparkles className="w-6 h-6 text-cyan-600" />
            </div>

            <h3 className="font-bold text-lg sm:text-xl text-slate-900 mb-2 sm:mb-3">
              No Minimum Order
            </h3>
          ...
          <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xs sm:shadow-lg p-5 sm:p-8 border border-slate-100">
            <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-green-100 flex items-center justify-center mb-4 sm:mb-5">
          ...
          <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xs sm:shadow-lg p-5 sm:p-8 border border-slate-100">
            <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-orange-100 flex items-center justify-center mb-4 sm:mb-5">
